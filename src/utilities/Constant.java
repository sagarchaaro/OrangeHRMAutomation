...
public class Constant {
	 ...
	 * "TEST CASE NAME" WILL BE IN COLOMN 1 AND 2 LOG IN DETAIL, IN EVERY SHEET
	 * THE USER ID AND PASSWORD WILL BE IN COLOMN 3 AND 4
	 */
	...
	public static final int FTE = 13;
	public static final int Temp_Department = 14;

	// Edit User test data columns
	// public static final int col_Locations = 5;
	// public static final int col_RandomName = 6;
	// public static final int col_RandomNumber = 7;
