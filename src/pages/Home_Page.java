...
public class Home_Page extends BaseClass{
	...
	public static void navigateMenu(String mainHeader, String subHeader, String branchHeader){
		// PIM Click
		driver.findElement(By.xpath("//span[text()='"+mainHeader+"']")).click();
		Reporter.log("Click action is performed on "+mainHeader+" in the Menu bar",true);
		...
		driver.findElement(By.xpath("//span[text()='"+branchHeader+"']")).click();
		Reporter.log("Click action is performed on "+branchHeader+" in the Menu bar",true);
